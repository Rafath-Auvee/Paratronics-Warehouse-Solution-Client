...
const tailwindtable = () => {
  return (
    <div>
      <div className="container relative overflow-x-auto shadow-md sm:rounded-lg sm:w">
        <div className="p-4">
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            ...
            <tr className="bg-gray-400 dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="w-4 p-4">
                <div className="flex items-center">
                  <input
